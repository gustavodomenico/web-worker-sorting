...
it("sorts the array", () => {
    ...
    expect(InsertionSort.run(input, 0, input.length)).toEqual(expected);
});
...
it("sorts the array from a specific index", () => {
    ...
    expect(InsertionSort.run(input, 2, input.length)).toEqual(expected);
});
...
it("sorts the array from an index with a specific step", () => {
    ...
    expect(InsertionSort.run(input, 1, 4)).toEqual(expected);
});
...
it("works on empty arrays", () => {
    ...
    expect(InsertionSort.run(input)).toEqual(expected);
});

it("calls the on progress callback for each index", () => {
    let callback = jest.fn();

    InsertionSort.run([1, 2, 3], 0, 3, callback);
